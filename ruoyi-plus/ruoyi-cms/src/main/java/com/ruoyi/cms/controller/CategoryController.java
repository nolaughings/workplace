...
public class CategoryController extends BaseController
{
    ...
    @GetMapping("/treeData")
    @ResponseBody
    public List<ZtreePlug> treeData()
    {
        List<ZtreePlug> ztrees = categoryService.selectCategoryTree();
        return ztrees;
    }
    ...
    @ResponseBody
    public List<ZtreePlug> treeDataWithArticle(HttpServletRequest request)
    {
        String root=request.getParameter("rootCategoryId");
        List<ZtreePlug> ztrees = categoryService.selectCategoryTreeWithArticle(root);
        return ztrees;
    }
}
