...
public class CmsConstants {
    ...
    public static final String KEY_COUPON_CATEGORY_PLUG="plug";//优惠券类型-插件
    public static final String KEY_COUPON_CATEGORY_TEMPLATE="template";//优惠券类型-模板
    public static final String KEY_COUPON_CATEGORY_VIP="vip";//优惠券类型-会员

    public static final String KEY_PAY_TYPE_ALIPAY="alipay";
    public static final String KEY_PAY_TYPE_WECHAT="wechat";
    public static final String KEY_PAY_TYPE_BALANCE="balance";

    public static final String KEY_ORDER_TYPE_TEMPLATE="template";//订单类型-购买模板
    public static final String KEY_ORDER_TYPE_PLUG="plug";//订单类型-购买插件
    public static final String KEY_ORDER_TYPE_RECHARGE="recharge";//订单类型-充值
    public static final String KEY_ORDER_TYPE_VIP="vip";//订单类型-会员

    public static final String KEY_MONEY_IN_OUT_TYPE_TEMPLATE="template";
    public static final String KEY_MONEY_IN_OUT_TYPE_PLUG="plug";
    public static final String KEY_MONEY_IN_OUT_TYPE_VIP="vip";
    public static final String KEY_MONEY_IN_OUT_TYPE_DONATE="donate";
    public static final String KEY_MONEY_IN_OUT_TYPE_RECHARGE="recharge";
}
