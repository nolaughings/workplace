package com.ruoyi.plugs.common.utils.path;
 ...
 *
 * <p>The default implementation is {@link com.ruoyi.framework.util.path.impl.AntPathMatcher}, supporting the Ant-style pattern syntax.		(borrowed from spring)
 */
