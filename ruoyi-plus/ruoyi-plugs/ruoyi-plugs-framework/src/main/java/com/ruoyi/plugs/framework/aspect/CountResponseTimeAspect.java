...
import com.ruoyi.plugs.common.utils.TimeUuidUtil;
import com.ruoyi.plugs.framework.manager.AsyncFactoryPlug;
...
public class CountResponseTimeAspect {
    ...
    public void doAfterReturning(Object ret) throws Throwable {
        ...
        if(spendTime>CONDITION_TIME){
            ...
            AsyncManager.me().execute(AsyncFactoryPlug.recordCostTime(costTime));
        }
    }
}
