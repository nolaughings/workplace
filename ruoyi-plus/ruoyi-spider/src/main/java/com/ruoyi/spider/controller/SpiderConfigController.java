...
import com.ruoyi.spider.service.SpiderMissionFinishServiceManager;
...
public class SpiderConfigController extends BaseController
{
    ...
    public String add(ModelMap modelMap)
    {
        ...
        List<String> spiderMissionFinishServiceList= SpiderMissionFinishServiceManager.getSpiderMissionFinishServiceList();
        modelMap.addAttribute("pipelineList",pipelineList);
        modelMap.addAttribute("spiderMissionFinishServiceList",spiderMissionFinishServiceList);
        return prefix + "/add";
    }
